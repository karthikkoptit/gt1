 ...
 */
public final class EnglishTextAnalyzer extends StopwordAnalyzerBase {
	 ...
	 */
	public EnglishTextAnalyzer(Version matchVersion) {
	 ...
	 *            a stopword set
	 */
	public EnglishTextAnalyzer(Version matchVersion, CharArraySet stopwords) {
	 ...
	 */
	public EnglishTextAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet stemExclusionSet) {
